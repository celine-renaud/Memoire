    ...
    for j in range(8):
        ...
        for k in range(8):
            if(k!=j):
                ...
                print(s[-1])
                label=s[-1]
        t=[nu,var,region,phrase,label,"BERT","Italien",0]
        table.append(t)
...
cfile = csv.writer(open('Resultats/Resultat_IT_BERT.csv', "w"))
